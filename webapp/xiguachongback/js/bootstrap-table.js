...
!function ($) {
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        html.push('</div>',
            '<div class="pull-right pagination">',
                '<ul class="pagination' + (this.options.iconSize == undefined ? '' :  ' pagination-' + this.options.iconSize)  + '">',
                    '<li class="page-first" title="首页"><a href="javascript:void(0)">&lt;&lt;</a></li>',
                    '<li class="page-pre" title="上一页"><a href="javascript:void(0)">&lt;</a></li>');
        ...
        html.push(
                    '<li class="page-next" title="下一页"><a href="javascript:void(0)">&gt;</a></li>',
                    '<li class="page-last" title="尾页"><a href="javascript:void(0)">&gt;&gt;</a></li>',
                '</ul>',
            '</div>');
