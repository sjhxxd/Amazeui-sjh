window.onload = function(){
  ...
  $(".left-nav a").click(function(){
    ...
    if(tab.html() == "首页"){     // 推荐项目
      ...
      changeTab(tabs, $(".tab > a:contains('排行榜')"));
    }else if(tab.html() == "最新项目"){     // 最新项目
      changeTab(tabs, $(".tab > a:contains('最新项目')"));
    }else if(tab.html() == "完成项目"){     // 完成项目
      changeTab(tabs, $(".tab > a:contains('完成项目')"));
    }
  })
...
function secondTab(tabs,currentTab){
...
function changeTab(tabs, currentTab){
  ...
  var yanchu = $(".yanchu");
  var caogen = $(".caogen");
  var guaziyule = $(".guaziyule");
  if(currentTab.html() == "推荐"){     // 推荐Tab 

    // 隐藏其它内容

    yanchu.css("display","none");
    caogen.css("display","none");
    guaziyule.css("display","none");
    ...
    //}
    setEleLocation();    
  }else if(currentTab.html() == "演出众筹"){     // 演出众筹Tab
    ...
    // 显示当前内容
    (yanchu.css("display") == "none") ? yanchu.css("display","block") : null;
    //if($(".yanchu ul").html() == "" || $(".yanchu ul").html() == null){
    //  yanchu.css("display","block");
    //  $(".yanchu ul").append(
    ...
    //}
  }else if(currentTab.html() == "草根众筹"){     // 草根众筹Tab
    ...
    // 显示当前内容 
    (caogen.css("display") == "none") ? caogen.css("display","block") : null;
    //if($(".caogen .caogen-list").html() == "" || $(".caogen .caogen-list").html() == null){
    //  $(".caogen .caogen-list").append(
    //
    //  );
    //}
  }else if(currentTab.html() == "瓜子娱乐"){     // 瓜子娱乐Tab
    ...
    // 显示当前内容
    (guaziyule.css("display") == "none") ? guaziyule.css("display","block") : null;
    //if($(".guaziyule ul").html() == "" || $(".guaziyule ul").html() == null){
    //  $(".guaziyule ul").append(
    //    //"<li class='am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-left' style='background:#202020;'>" +
    //    //"<div class='am-u-sm-4 am-list-thumb'>" +
    //    //"<img src='imgs/wancheng/tupian@2x.png' class='am-img-responsive guaziyule-poster'/></div>" +
    //    //"<div class='am-u-sm-8 am-list-main'>" +
    //    //"<p class='guaziyule-title'>薛之谦演唱会</p>" +
    //    //"<div class='guaziyule-content'>" +
    //    //"<span>目标: 1500</span><span>已筹: 200</span>" +
    //    //"<span>时间: 6天</span><span>用时: 4天</span></div>" +
    //    //"<img class='guaziyule-icon' src='imgs/wancheng/chenggong.png'>" +
    //    //"<span class='guaziyule-ok'>已完成</span>" +
    //    //"<img class='guaziyule-jiantou' src='imgs/wancheng/xiayiji@2x.png'></div></li>"
    //  );
    //  // Hack一下箭头的位置
